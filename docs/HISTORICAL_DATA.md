...
The [public-source acquisition record](PUBLIC_INPUTS.md) now documents 175 acquired/extracted references for the rows below. Semantic normalization, historical availability, licence exceptions and reconciliation remain; no historical bundle role has been silently populated.
...
| CAPEX, fixed/variable O&M, efficiency and lifetime | [DESNZ generation cost projections](https://www.gov.uk/government/collections/energy-generation-cost-projections) | Reports/annexes acquired; pin publication vintages, money basis and technology mapping. Current estimates are not historical investor information |
